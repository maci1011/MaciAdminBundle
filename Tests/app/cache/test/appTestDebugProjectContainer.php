...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'maci.admin' => 'getMaci_AdminService',
            'maci_admin.menu.admin_actions' => 'getMaciAdmin_Menu_AdminActionsService',
            'maci_admin.menu.admin_entities' => 'getMaciAdmin_Menu_AdminEntitiesService',
            'maci_admin.menu.admin_item_actions' => 'getMaciAdmin_Menu_AdminItemActionsService',
            'maci_admin.menu.admin_sections' => 'getMaciAdmin_Menu_AdminSectionsService',
            'maci_admin.menu_builder' => 'getMaciAdmin_MenuBuilderService',
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 2 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'base', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_50da9262fd7489b85e54d01148a60eaf8ec1eab4f5238e00ebf064d5810721e6');
    ...
    {
        return $this->services['knp_menu.menu_provider'] = new \Knp\Menu\Provider\ChainProvider(array(0 => new \Knp\Bundle\MenuBundle\Provider\ContainerAwareProvider($this, array('admin_entities' => 'maci_admin.menu.admin_entities', 'admin_sections' => 'maci_admin.menu.admin_sections', 'admin_actions' => 'maci_admin.menu.admin_actions', 'admin_item_actions' => 'maci_admin.menu.admin_item_actions')), 1 => new \Knp\Bundle\MenuBundle\Provider\BuilderServiceProvider($this, array()), 2 => new \Knp\Bundle\MenuBundle\Provider\BuilderAliasProvider($this->get('kernel'), $this, $this->get('knp_menu.factory'))));
    }
    ...
    {
        return $this->services['knp_menu.renderer.twig'] = new \Knp\Menu\Renderer\TwigRenderer($this->get('twig'), 'MaciCoreBundle:Menu:knp_menu.html.twig', $this->get('knp_menu.matcher'), array());
    }
    ...
    /**
     * Gets the 'maci.admin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Maci\AdminBundle\Controller\AdminController A Maci\AdminBundle\Controller\AdminController instance.
     */
    protected function getMaci_AdminService()
    {
        return $this->services['maci.admin'] = new \Maci\AdminBundle\Controller\AdminController($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'), $this->get('session'), $this->get('request_stack'), $this->get('kernel'), $this->get('form.factory'), $this->get('form.registry'), $this->get('router'), array('sections' => array(), 'options' => array('page_limit' => 30, 'page_range' => 7)));
    }

    /**
     * Gets the 'maci_admin.menu.admin_actions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'maci_admin.menu.admin_actions' service is requested while the 'request' scope is not active
     */
    protected function getMaciAdmin_Menu_AdminActionsService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maci_admin.menu.admin_actions', 'request');
        }

        return $this->services['maci_admin.menu.admin_actions'] = $this->scopedServices['request']['maci_admin.menu.admin_actions'] = $this->get('maci_admin.menu_builder')->createActionsMenu($this->get('request'));
    }

    /**
     * Gets the 'maci_admin.menu.admin_entities' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'maci_admin.menu.admin_entities' service is requested while the 'request' scope is not active
     */
    protected function getMaciAdmin_Menu_AdminEntitiesService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maci_admin.menu.admin_entities', 'request');
        }

        return $this->services['maci_admin.menu.admin_entities'] = $this->scopedServices['request']['maci_admin.menu.admin_entities'] = $this->get('maci_admin.menu_builder')->createEntitiesMenu($this->get('request'));
    }

    /**
     * Gets the 'maci_admin.menu.admin_item_actions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'maci_admin.menu.admin_item_actions' service is requested while the 'request' scope is not active
     */
    protected function getMaciAdmin_Menu_AdminItemActionsService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maci_admin.menu.admin_item_actions', 'request');
        }

        return $this->services['maci_admin.menu.admin_item_actions'] = $this->scopedServices['request']['maci_admin.menu.admin_item_actions'] = $this->get('maci_admin.menu_builder')->createItemActionsMenu($this->get('request'));
    }

    /**
     * Gets the 'maci_admin.menu.admin_sections' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'maci_admin.menu.admin_sections' service is requested while the 'request' scope is not active
     */
    protected function getMaciAdmin_Menu_AdminSectionsService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maci_admin.menu.admin_sections', 'request');
        }

        return $this->services['maci_admin.menu.admin_sections'] = $this->scopedServices['request']['maci_admin.menu.admin_sections'] = $this->get('maci_admin.menu_builder')->createSectionsMenu($this->get('request'));
    }

    /**
     * Gets the 'maci_admin.menu_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Maci\AdminBundle\Menu\AdminMenuBuilder A Maci\AdminBundle\Menu\AdminMenuBuilder instance.
     */
    protected function getMaciAdmin_MenuBuilderService()
    {
        return $this->services['maci_admin.menu_builder'] = new \Maci\AdminBundle\Menu\AdminMenuBuilder($this->get('knp_menu.factory'), $this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'), $this->get('maci.admin'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[4].'/Resources/views'), 'MaciAdmin');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'security.validator.user_password' => 'security.validator.user_password', 'validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email')));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5819428d28944')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MaciAdminBundle' => 'Maci\\AdminBundle\\MaciAdminBundle',
            ),
            ...
            'knp_menu.renderer.twig.template' => 'MaciCoreBundle:Menu:knp_menu.html.twig',
